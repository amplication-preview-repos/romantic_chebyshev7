...
class DetectedFaceCreateInput {
  ...
  @ApiProperty({
    required: false,
    type: () => RecognizedFaceCreateNestedManyWithoutDetectedFacesInput,
  })
  @ValidateNested()
  @Type(() => RecognizedFaceCreateNestedManyWithoutDetectedFacesInput)
  @IsOptional()
  @Field(() => RecognizedFaceCreateNestedManyWithoutDetectedFacesInput, {
    nullable: true,
  })
...
export { DetectedFaceCreateInput as DetectedFaceCreateInput };
